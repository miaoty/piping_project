...
libircmd_dll=last_path+'\libircmd\Release\\x64\dll\libircmd.dll'
src_dll_list=[libirparse_dll,libirprocess_dll,libiruvc_dll,libircmd_dll]
...
libircmd_lib=last_path+'\libircmd\Release\\x64\dll\libircmd.lib'
src_lib_list=[libirparse_lib,libirprocess_lib,libiruvc_lib,libircmd_lib]
...
libircmd_basic_header=last_path+'\libircmd\\include\\libircmd.h'

src_header_list=[libirparse_header, libirprocess_header, \
                 libiruvc_header, libircmd_basic_header]
